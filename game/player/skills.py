...
class SkillSystem:
    ...
    def apply_skill_to_action(
        self, skill_type: SkillType, difficulty: int
    ) -> Dict[str, Any]:
        """
    ...
    def combine_skills(
        ...
        """
        primary_result = self.apply_skill_to_action(primary_skill, difficulty)
        secondary_result = self.apply_skill_to_action(secondary_skill, difficulty)
