...
LOCATION_TEMPLATES = {
    ...
    "police_station": Location(
        ...
        clues=["протоколы", "фотографии", "записи допросов", "досье", "отчеты"],
...
SUSPECT_TEMPLATES = {
    "primary": Suspect(
        ...
        evidence=["отпечатки", "ДНК", "документы", "фотографии", "записи"],
        is_guilty=False,
    )
}
...
FINAL_SCENES = {
    "success": {
        ...
        "rewards": {
            ...
            "reputation": 50,
            "money": 1000,
            "items": ["медаль", "благодарность", "документы"],
        },
    },
    "partial_success": {
